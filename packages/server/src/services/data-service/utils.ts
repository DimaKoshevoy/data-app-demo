...
export const sortAddresses = (tokenA: string, tokenB: string) => sortsBefore(tokenA, tokenB) ? [tokenA, tokenB] : [tokenB, tokenA];
...
export const getQuotePairAddress = (tokenAddress: string) => getPairAddress(tokenAddress, QUOTE_CURRENCY);

export const getPriceInUSD = (usdPriceInQuote: number, tokenPriceInQuote: number) =>
